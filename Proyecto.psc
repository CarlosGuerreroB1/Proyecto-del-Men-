...
funcion cantidad_de_colas
    ...
    Si cantidadColas > 23 Entonces
        costoPorUnidad = 0.50
    Sino
        costoPorUnidad = 1.20 * 0.50 // 20% más del costo base
    FinSi
...
Funcion ganancias_uvas
    ...
    // Pedir el tamaño de la uva (1 o 2)
    Escribir "Ingresa el tamaño de la uva: 1 o 2"
    Leer tamaño
	
    // Evaluar el tipo de uva y ajustar el precio según el tamaño
    Si tipo = "A" Entonces
...
Funcion consultorio_paez
    ...
    // Pedir al usuario que ingrese el número de cita
    Escribir "Ingrese el número de cita: "
    Leer numeroCita
	
    // Calcular el costo de la consulta según la política
...
Funcion numnegativo
	...
	Sino
		...
		Si num Mod 7 == 0 Entonces
			Escribir "El numero es múltiplo de 7"
		FinSi
	FinSi
...
funcion pitahaya
Definir tipo, tamaño, precio_inicial, precio_final Como Real;
...
funcion operacionarreglocadena_10
	...
	Definir tipo, tamaño, precioInicial, precioFinal, IVA Como Real;
...
funcion operacionconcadenayarreglos11
	...
	SiNo
		...
		SiNo
			Si num mod 5 == 0 Entonces
				mensaje <- "El número es divisible por 5";
			SiNo
				mensaje <- "El número no es divisible por 5";
			FinSi
		FinSi
	FinSi
	...
	Escribir "El número ingresado es: ", arreglo[0];
	Escribir arreglo[1];
FinFuncion
...
funcion NumerosImparesComprendidos
	...
	Para i<-1 Hasta 3 Con Paso 1 Hacer
		Escribir num(i)
	Fin Para
    Escribir "Ingrese el primer número:","(Ingreselo 2 veces para verificar)"
    Leer num(1)
	Leer numero1
    Escribir "Ingrese el segundo número:"
    Leer num(2)
